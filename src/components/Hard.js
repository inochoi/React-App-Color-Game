...
const Easy = props => {
  ...
  const generateRandomColors = num => {
    ...
    let i = Math.abs(Math.ceil(Math.random() * 12 - 1));
            ...
            <div className="container">
              ...
              // store color value when one of the squares is clicked */}
                ...
                <div className="box">
                  ...
                  <div
                    className="squareH"
                    style={{ backgroundColor: colorArray[7] }}
                    onClick={clickHandler}
                  />
                  <div
                    className="squareH"
                    style={{ backgroundColor: colorArray[8] }}
                    onClick={clickHandler}
                  />
                  <div
                    className="squareH"
                    style={{ backgroundColor: colorArray[9] }}
                    onClick={clickHandler}
                  />
                  <div
                    className="squareH"
                    style={{ backgroundColor: colorArray[10] }}
                    onClick={clickHandler}
                  />
                  <div
                    className="squareH"
                    style={{ backgroundColor: colorArray[11] }}
                    onClick={clickHandler}
                  />
                </div>
              </div>
